...
%%%%%%%%%% Modelo simplificado: se asume una difracci�n puramente radial desde el
%%%%%%%%%% dispersor, con el valor correspondiente a dispersi�n directa (�o
%%%%%%%%%% retrodispersi�n? a comprobar)
...
%%%%%%%%%% El par�metro de salida SL2 es la presi�n dispersada compleja en
%%%%%%%%%% funci�n de la frecuencia.




%% Modelo celular (leucocito) ���ATENCION, ESTOS TRES PAR�METROS VAN FUERA DE LA FUNCI�N, EN EL PROGRAMA PRINCIPAL!!!
% rof = 998
% c = 1500
% rop = 1064
% cpl = 1585
...
nfo=5;         %%% Orden m�ximo de la serie de polinomios.
clear ln2
